...
latex_template_path = 'performance.tex'

# Open and read the JSON file
with open(json_file_path, 'r') as file:
    data = json.load(file)

# Extracting performance ratios data from the JSON
...
rendered_latex = template.render(**performance_ratios_dict)
